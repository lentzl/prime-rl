...
| `[orchestrator.algo]` | Training algorithm bundle; `algo.advantage.type` selects `grpo` default, `max_rl`, `opd`, `opsd`, `sft`, `sft_distill`, `echo`, `reward`, or `custom`. See [Algorithms](#algorithms). |
