...
def _terminal_plan() -> dict[str, object]:
    return {
        ...
        "run_identity": "b-hic0-identity-carrier-r1",
        "run1_failure_dependency": {
            "failure_file_sha256": "f" * 64,
            "failure_internal_receipt_sha256": "i" * 64,
        },
...
def _success_receipt() -> dict[str, object]:
    ...
    return _seal({
        ...
        "run_identity": "b-hic0-identity-carrier-r1",
        "bound_run1_failure_file_sha256": "f" * 64,
        "bound_run1_failure_internal_receipt_sha256": "i" * 64,
