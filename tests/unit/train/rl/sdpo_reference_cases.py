"""Fixed trainer-side reference cases from ``lasgroup/SDPO@c52586b``.

The values were generated from the author-lineage
``compute_self_distillation_loss`` implementation and checked into the tests so
prime-rl does not import or install the reference repository. The cases cover
sampled-token distillation, full-vocabulary KL/JSD, top-k tail aggregation,
importance clipping, and token/sequence rollout-importance normalization.
"""
