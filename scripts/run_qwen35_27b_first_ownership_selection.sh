...
OUTPUT_ROOT=/ephemeral/subagent-rung/evals/246-qwen35-27b-first-ownership-selection-r1
CONFIG=configs/debug/subagent-communication/246-qwen35-27b-first-ownership-selection.toml
ADAPTER_NAME=qwen35-27b-first-ownership-step1
ADAPTER_PATH=/ephemeral/subagent-rung/outputs/245-qwen35-27b-first-ownership-grpo-dose-r1/weights/step_1
