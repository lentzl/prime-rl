...
CONFIG=configs/debug/subagent-communication/254-qwen35-27b-aligned-first-response-opsd.toml

cd "$ROOT"
# A fresh server guarantees that the rollout starts from the untouched base.
