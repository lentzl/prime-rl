...
label=${2:-base}
output_root=${PRIME_MASTERY_OUTPUT_ROOT:-/ephemeral/subagent-rung/evals/336-339-qwen35-27b-memory-v2-teacher-admission}/${label}
eval_bin=${EVAL_BIN:-$root/.venv/bin/eval}
client_base_url=${EVAL_CLIENT_BASE_URL:-}

configs=(
  336-qwen35-27b-memory-v2-familiar-unconditioned
  337-qwen35-27b-memory-v2-familiar-conditioned
  338-qwen35-27b-memory-v2-ood-unconditioned
  339-qwen35-27b-memory-v2-ood-conditioned
)
