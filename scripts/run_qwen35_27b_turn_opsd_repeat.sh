...
OUTPUT_ROOT=/ephemeral/subagent-rung/evals/239-qwen35-27b-turn-opsd-repeat-r1
CONFIG=configs/debug/subagent-communication/239-qwen35-27b-turn-opsd-repeat.toml
