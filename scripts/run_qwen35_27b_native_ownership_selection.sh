...
OUTPUT_ROOT=/ephemeral/subagent-rung/evals/252-qwen35-27b-native-ownership-selection-r1
CONFIG=configs/debug/subagent-communication/252-qwen35-27b-native-ownership-selection.toml
ADAPTER_NAME=qwen35-27b-native-ownership-step1
ADAPTER_PATH=/ephemeral/subagent-rung/outputs/251-qwen35-27b-native-ownership-sft-r1/weights/step_1
