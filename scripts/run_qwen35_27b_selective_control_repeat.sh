...
OUTPUT_ROOT=/ephemeral/subagent-rung/evals/236-qwen35-27b-selective-control-repeat-r1
CONFIG=configs/debug/subagent-communication/236-qwen35-27b-selective-control-repeat.toml
