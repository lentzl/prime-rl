...
OUTPUT_ROOT=/ephemeral/subagent-rung/evals/241-qwen35-27b-first-coordinator-opsd-selection-r1
CONFIG=configs/debug/subagent-communication/241-qwen35-27b-first-coordinator-opsd-selection.toml
ADAPTER_NAME=qwen35-27b-first-coordinator-opsd-step1
ADAPTER_PATH=/ephemeral/subagent-rung/outputs/240-qwen35-27b-first-coordinator-opsd-dose-r1/weights/step_1
