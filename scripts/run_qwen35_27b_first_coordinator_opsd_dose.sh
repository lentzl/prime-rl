...
CONFIG=configs/debug/subagent-communication/240-qwen35-27b-first-coordinator-opsd-dose.toml

cd "$ROOT"
# Always restart so a previously loaded diagnostic adapter cannot affect the fresh-base rollout.
