...
student=${PRIME_AGENT_OPD_STUDENT:?set PRIME_AGENT_OPD_STUDENT to an official Qwen 3.5 model}
student_revision=${PRIME_AGENT_OPD_STUDENT_REVISION:?set PRIME_AGENT_OPD_STUDENT_REVISION to a pinned model revision}
output=${PRIME_AGENT_OPD_OUTPUT:?set PRIME_AGENT_OPD_OUTPUT to a fresh output directory}
max_steps=${PRIME_AGENT_OPD_MAX_STEPS:-1}
teacher_log=${PRIME_AGENT_OPD_TEACHER_LOG:-/ephemeral/subagent-rung/logs/qwen35-27b-opd-teacher.log}
