...
OUTPUT_ROOT=/ephemeral/subagent-rung/evals/255-qwen35-27b-aligned-first-response-selection-r1
CONFIG=configs/debug/subagent-communication/255-qwen35-27b-aligned-first-response-selection.toml
ADAPTER_NAME=qwen35-27b-aligned-first-response-step1
ADAPTER_PATH=/ephemeral/subagent-rung/outputs/254-qwen35-27b-aligned-first-response-opsd-r1/weights/step_1
