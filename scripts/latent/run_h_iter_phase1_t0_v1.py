...
def preflight(repo:Path,execution_commit:str,plan_file_sha256:str)->dict:
    ...
    plan=strict_loads(plan_path.read_bytes()); validate_plan(plan,proof_input=False)
...
def run_full(repo:Path,execution_commit:str,plan_file_sha256:str)->None:
    ...
    asset_pre_sha=sha256_bytes(canonical_json(asset_pre)); FAILURE_EVIDENCE["asset_audit"]={"target_count":38,"pre_entries":asset_pre,"pre_sha256":asset_pre_sha,"post_entries":None,"post_sha256":None,"all_exact":None}
