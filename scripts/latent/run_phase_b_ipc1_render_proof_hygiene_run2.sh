...
readonly PLAN="$EXPERIMENT_DIR/phase-b-ipc1-render-proof-hygiene-run2-plan.json"
readonly FREEZE_MANIFEST="$EXPERIMENT_DIR/phase-b-ipc1-render-proof-hygiene-run2.sha256"
readonly OUTPUT_DIR=/home/ubuntu/rlm/outputs/q35-2b-ipc1-render-proof-hygiene-v1-run2
readonly MECHANISM_COMMIT=72a3e77fc3a904a0af2c3d72195671b8dcaff11a
...
[[ $(sha256sum "$UV_PROJECT/pyproject.toml" | cut -d' ' -f1) == 504907808f992f1e6883f54c2695a4814ae77d6b80814239cbfc98d81a543656 ]]
[[ $(sha256sum "$UV_PROJECT/uv.lock" | cut -d' ' -f1) == fca5fa6183345b5b68974078c38d58e0320f79eef13a695af11ceab12fdf36d5 ]]
