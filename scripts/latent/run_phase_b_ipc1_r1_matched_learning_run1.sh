...
readonly PLAN="$EXPERIMENT_DIR/phase-b-ipc1-r1-matched-learning-run1-plan.json"
readonly FREEZE_MANIFEST="$EXPERIMENT_DIR/phase-b-ipc1-r1-matched-learning-run1.sha256"
readonly OUTPUT_DIR=/home/ubuntu/rlm/results/q35-2b-b-ipc1-r1-matched-learning-run1
...
[[ $(git rev-parse "$EXECUTION_COMMIT^") == e5d6fecbb4fbc769b18371c7b404496d65af0f26 ]]
