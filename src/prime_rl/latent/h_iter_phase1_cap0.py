...
def build_contract(selection: dict[str, Any], capture: dict[str, Any]) -> dict[str, Any]:
    return finish({
        ...
        "output_contract": {"logits_shape": [24, 1, 248320], "full_hidden_shape": [24, 128, 2048], "capture_shape": [24, 2048], "dtype": "torch.bfloat16", "pkv_none": True, "repeat_input_mask_hidden_capture_bitwise": True, "logit_repeat_equality_descriptive_only": True, "unique_capture_rows_minimum": 2},
