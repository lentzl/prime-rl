...
MECHANISM = "q35-2b-h-iter-phase1-cap0-r1-v1"
RUN_ID = "h-iter-phase1-cap0-r1-capture-run1"
OUTPUT_ROOT = "/home/ubuntu/rlm/outputs/q35-2b-h-iter-phase1-cap0-r1-capture-run1"
ARTIFACT_DIR = "experiments/qwen35-2b-latent-workspace-v1/h-iter-phase1-cap0-r1-v1"
PLAN_SCHEMA = "prime-rl/latent-h-iter-phase1-cap0-r1-plan/v1"
CONTRACT_SCHEMA = "prime-rl/latent-h-iter-phase1-cap0-r1-contract/v1"
PREFLIGHT_SCHEMA = "prime-rl/latent-h-iter-phase1-cap0-r1-preflight/v1"
PROOF_SCHEMA = "prime-rl/latent-h-iter-phase1-cap0-r1-proof/v1"
FAILURE_SCHEMA = "prime-rl/latent-h-iter-phase1-cap0-r1-failure/v1"
PREFLIGHT_STATUS = "h_iter_phase1_cap0_r1_preflight_validated"
PROOF_STATUS = "h_iter_phase1_cap0_r1_capture_mechanism_validated"
REJECT_STATUS = "h_iter_phase1_cap0_r1_capture_mechanism_rejected"
INCOMPLETE_STATUS = "h_iter_phase1_cap0_r1_incomplete"
EXPOSURE_STATUS = "h_iter_phase1_cap0_r1_exposure_boundary_rejected"
...
ANTECEDENT_BINDING = {
    "manifest_path": f"{ARTIFACT_DIR}/cap0-r1-antecedent-evidence-manifest.json",
    "manifest_file_sha256": "0a06a7800908aabd29936610687581fd36429b7d1335f85c098fc72bb18856ed",
    "manifest_internal_sha256": "bd76a23bbb510d03e5388f4a6932f8204cbbe10c9eedc6f5262d283b145e0799",
    "ordered_evidence_asset_count": 6,
}
...
TAMPERS = [
    ...
    "antecedent_manifest_file_hash_changed", "antecedent_manifest_internal_hash_changed",
    "antecedent_failure_file_hash_changed", "antecedent_failure_internal_hash_changed",
    "antecedent_launcher_log_hash_changed", "antecedent_exit_hash_changed",
    "antecedent_preflight_file_hash_changed", "antecedent_preflight_internal_hash_changed",
    "antecedent_preflight_stderr_hash_changed", "antecedent_preflight_exit_hash_changed",
    "module_state_hash_dialect_changed", "scientific_tensor_hash_dialect_changed",
    "old_namespace_reuse_allowed",
]
MECHANISM_CAUSES = {
...
COUNTS = {
    ...
    "cache_checks": 18, "tampers": 55, "memory_rows": 28,
}
DECISION = {
...
def build_contract(selection: dict[str, Any], capture: dict[str, Any]) -> dict[str, Any]:
    return finish({
        ...
        "status": "cap0_r1_contract_preregistered",
        "mechanism": MECHANISM,
