...
from prime_rl.trainer.optim import optimizer_update_succeeded, setup_multi_optimizer, setup_optimizer
...
def train(config: TrainerConfig):
    ...
    while True:
        ...
        if weight_broadcast is None:
            ...
            nccl_broadcast_unused = config.weight_broadcast.type == "nccl" and nccl_broadcast_is_unused(
